...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gstlal-calibration-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gstlal-calibration-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gstlal-calibration
# for installing globally
pixi global install gstlal-calibration
```
...
It is possible to list all of the versions of `gstlal-calibration` available on your platform:
...
```
pixi search gstlal-calibration --channel conda-forge
```
